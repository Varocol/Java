...
public class OperationsTable extends MyTable {
    public OperationsTable(String[] columnNames) {
        super(columnNames);
        Class<?>[] columns = new Class<?>[]{String.class, String.class, String.class, String.class,
                Date.class, Double.class, Integer.class, String.class};
